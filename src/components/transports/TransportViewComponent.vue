...
import { TransportUpdateDto } from '../../dtos/transports/TransportUpdateDto'; // Adjust the import path
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      updateData: new TransportUpdateDto(),
    }
  },
  methods: {
    load() {
    ...
    async handleSubmit() {
      ...
      try {
        ...
        const response = await axios.put('/api/transports/'+this.id, formData);      
        ...
        <div class="relative w-full max-w-md max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
              <h5 text-center class="mb-4 text-center text-xl font-medium text-gray-900 dark:text-white">{{ t('transport') }} {{ t('update') }}</h5>
              <form class="space-y-6" action="#">
                ...
                <div>
                  ...
                  <input v-model="updateData.pricePerHours" type="text" id="pricePerHours" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                </div>
