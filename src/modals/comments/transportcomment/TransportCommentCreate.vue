  ...
  <div class="modal-overlay" >
    <div class="modal">
      ...
      <form @submit.prevent="handleSubmit" class="form">
        ...
        <input v-model="formData.transportId" type="text" id="instrumentId" class="input" required>
...
import { TransportCommentDto } from '../../../dtos/comments/transprotcomments/TransportCommentCreateDto'; // Adjust the import path
import { useI18n } from 'vue-i18n';
import { TransportCommentViewModel } from '../../../viewmodels/TransportCommentViewModel';

export default {
name: 'TransportCommentCreateDto',
data() {
  return {
      formData: new TransportCommentDto(1, true)
  };
},
methods: {
  closeModal() {
  ...
  async handleSubmit() {
    try {
      ...
      const response = await axios.post('/api/transports/comments', this.formData);
      this.closeModal();
